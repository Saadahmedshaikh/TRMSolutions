  ...
  tabPane() {
    return (
      <>
            ...
            <Form className="form-horizontal" id="form1">
                ...
                <Col md="4">
                    ...
                    <FormGroup row>
                        ...
                        <Col xs="8" md="8">
                        <Input type="text" id="AssetGroup" size="sm"/>
                        </Col>
                    </FormGroup>
                    <FormGroup row>
                        <Col xs="3" md="3">
                    ...
                    <FormGroup row>
                        ...
                        <Col xs="8" md="8">
                        <Input type="text" id="Category" size="sm"/>
                        </Col>
                    </FormGroup>
                    <FormGroup row>
                        <Col xs="3" md="3">
                        ...
                        <Col xs="8" md="8">
                        <Input type="text" id="SpecsCategory" size="sm"/>
                        </Col>
                    </FormGroup>
                    <FormGroup row>
                        <Col xs="3" md="3">
        ...
        <TabPane tabId="2">
        <Card>
                <CardHeader>Specification</CardHeader>
                <CardBody>
                  <Table>
                    <tr>
          ...
          // Axios.get('http://localhost:37329/Equipment/getequipment/'+this.props.location.state.id)
            ...
            .then(response =>{
               ...
               {/* for card one */}
                ...
                document.getElementById("AssetGroup").value=this.state.details[0].AssetGroup;
            ...
            {/* for card two */}
            Axios.get("http://localhost:37329/Equipment/scheduleEquipment/0EFC4904-DC51-48B6-B704-81FD460208FD")
            .then(response =>{
            ...
            Axios.get("http://localhost:37329/Equipment/Specification/0EFC4904-DC51-48B6-B704-81FD460208FD")
            .then(response =>{
              const temp = JSON.parse(response.data);
              this.setState({
                Specification:temp
